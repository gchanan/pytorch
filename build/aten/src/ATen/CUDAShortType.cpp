...
int64_t CUDAShortType::_th_storage_offset(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return static_cast<int64_t>(THCudaShortTensor_storageOffset(globalContext().getTHCState(), self_));
}
int64_t CUDAShortType::_th_ndimension(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return static_cast<int64_t>(THCudaShortTensor_nDimension(globalContext().getTHCState(), self_));
}
...
Tensor & CUDAShortType::_fill_(Tensor & self, Scalar value) const {
...
Tensor & CUDAShortType::_fill_(Tensor & self, const Tensor & value) const {
    const DeviceGuard device_guard(self);
    if (value.dim() == 0) {
...
bool CUDAShortType::_th_is_contiguous(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return THCudaShortTensor_isContiguous(globalContext().getTHCState(), self_);
}
...
void* CUDAShortType::data_ptr(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return THCudaShortTensor_data(globalContext().getTHCState(), self_);
}
...
Tensor CUDAShortType::_th_min(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return scalarTensor(convert<int16_t>(THCudaShortTensor_minall(globalContext().getTHCState(), self_)));
}
...
Tensor CUDAShortType::_th_max(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return scalarTensor(convert<int16_t>(THCudaShortTensor_maxall(globalContext().getTHCState(), self_)));
}
...
Tensor CUDAShortType::_th_median(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return scalarTensor(convert<int16_t>(THCudaShortTensor_medianall(globalContext().getTHCState(), self_)));
}
...
Tensor & CUDAShortType::_cumsum_out(Tensor & result, const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(result);
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Short);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CUDAShortType::_cumsum(const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(self);
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int16_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
...
Tensor & CUDAShortType::_cumprod_out(Tensor & result, const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(result);
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Short);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CUDAShortType::_cumprod(const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(self);
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int16_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
...
Tensor CUDAShortType::_th_trace(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    return scalarTensor(convert<int16_t>(THCudaShortTensor_trace(globalContext().getTHCState(), self_)));
}
...
Tensor & CUDAShortType::s_th_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const DeviceGuard device_guard(result);
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Short);
...
Tensor CUDAShortType::s_th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const DeviceGuard device_guard(self);
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<int16_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto beta_ = beta.toShort();
...
Tensor & CUDAShortType::th_addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Short);
    auto beta_ = beta.toShort();
    auto alpha_ = alpha.toShort();
