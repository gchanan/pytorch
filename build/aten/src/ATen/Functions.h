...
static inline Tensor & _th_potrf_out(Tensor & output, const Tensor & self, bool upper=true);
static inline Tensor _th_potrf(const Tensor & self, bool upper=true);
static inline Tensor & _th_potrs_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper=true);
static inline Tensor _th_potrs(const Tensor & self, const Tensor & input2, bool upper=true);
...
static inline Tensor & potrf_out(Tensor & result, const Tensor & self, bool upper=true);
...
static inline Tensor & _th_potrf_out(Tensor & output, const Tensor & self, bool upper) {
    return detail::infer_type(self)._th_potrf_out(output, self, upper);
}
static inline Tensor _th_potrf(const Tensor & self, bool upper) {
    return detail::infer_type(self)._th_potrf(self, upper);
}
static inline Tensor & _th_potrs_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper) {
    return detail::infer_type(self)._th_potrs_out(result, self, input2, upper);
}
static inline Tensor _th_potrs(const Tensor & self, const Tensor & input2, bool upper) {
    return detail::infer_type(self)._th_potrs(self, input2, upper);
}
...
static inline Tensor & potrf_out(Tensor & result, const Tensor & self, bool upper) {
    return detail::infer_type(self).potrf_out(result, self, upper);
}
