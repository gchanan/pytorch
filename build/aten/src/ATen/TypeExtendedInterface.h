...
struct CAFFE2_API TypeExtendedInterface : public Type {
  ...
  virtual Tensor & _th_potrf_out(Tensor & output, const Tensor & self, bool upper) const = 0;
  virtual Tensor & _th_potrs_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper) const = 0;
  ...
  virtual Tensor & potrf_out(Tensor & result, const Tensor & self, bool upper) const = 0;
