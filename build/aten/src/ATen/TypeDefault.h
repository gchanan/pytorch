...
struct CAFFE2_API TypeDefault : public TypeExtendedInterface {
  ...
  int64_t _th_storage_offset(const Tensor & self) const override;
  int64_t _th_ndimension(const Tensor & self) const override;
  ...
  bool _th_is_contiguous(const Tensor & self) const override;
  ...
  Tensor & _th_potrf_out(Tensor & output, const Tensor & self, bool upper) const override;
  Tensor _th_potrf(const Tensor & self, bool upper) const override;
  Tensor & _th_potrs_out(Tensor & result, const Tensor & self, const Tensor & input2, bool upper) const override;
  Tensor _th_potrs(const Tensor & self, const Tensor & input2, bool upper) const override;
  ...
  Tensor & potrf_out(Tensor & result, const Tensor & self, bool upper) const override;
