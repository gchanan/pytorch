...
int64_t CUDAByteType::_th_storage_offset(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return static_cast<int64_t>(THCudaByteTensor_storageOffset(globalContext().getTHCState(), self_));
}
int64_t CUDAByteType::_th_ndimension(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return static_cast<int64_t>(THCudaByteTensor_nDimension(globalContext().getTHCState(), self_));
}
...
Tensor & CUDAByteType::_fill_(Tensor & self, Scalar value) const {
...
Tensor & CUDAByteType::_fill_(Tensor & self, const Tensor & value) const {
    const DeviceGuard device_guard(self);
    if (value.dim() == 0) {
...
bool CUDAByteType::_th_is_contiguous(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return THCudaByteTensor_isContiguous(globalContext().getTHCState(), self_);
}
...
void* CUDAByteType::data_ptr(const Tensor & self) const {
    // DeviceGuard omitted
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return THCudaByteTensor_data(globalContext().getTHCState(), self_);
}
...
Tensor CUDAByteType::_th_min(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return scalarTensor(convert<uint8_t>(THCudaByteTensor_minall(globalContext().getTHCState(), self_)));
}
...
Tensor CUDAByteType::_th_max(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return scalarTensor(convert<uint8_t>(THCudaByteTensor_maxall(globalContext().getTHCState(), self_)));
}
...
Tensor CUDAByteType::_th_median(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return scalarTensor(convert<uint8_t>(THCudaByteTensor_medianall(globalContext().getTHCState(), self_)));
}
...
Tensor CUDAByteType::_th_all(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return scalarTensor(convert<uint8_t>(THCudaByteTensor_logicalAndAll(globalContext().getTHCState(), self_)));
}
...
Tensor CUDAByteType::_th_any(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return scalarTensor(convert<uint8_t>(THCudaByteTensor_logicalAnyAll(globalContext().getTHCState(), self_)));
}
...
Tensor & CUDAByteType::_cumsum_out(Tensor & result, const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(result);
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Byte);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CUDAByteType::_cumsum(const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(self);
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<uint8_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
...
Tensor & CUDAByteType::_cumprod_out(Tensor & result, const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(result);
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Byte);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CUDAByteType::_cumprod(const Tensor & self, int64_t dim) const {
    const DeviceGuard device_guard(self);
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<uint8_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
...
Tensor CUDAByteType::_th_trace(const Tensor & self) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    return scalarTensor(convert<uint8_t>(THCudaByteTensor_trace(globalContext().getTHCState(), self_)));
}
...
Tensor & CUDAByteType::s_th_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const DeviceGuard device_guard(result);
    auto result_ = checked_tensor_unwrap(result,"result",0, false, Backend::CUDA, ScalarType::Byte);
...
Tensor CUDAByteType::s_th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const DeviceGuard device_guard(self);
    auto result_ = c10::make_intrusive<TensorImpl, UndefinedTensorImpl>(CUDATensorId(), caffe2::TypeMeta::Make<uint8_t>(), allocator(), false).release();
    auto result = Tensor(c10::intrusive_ptr<TensorImpl, UndefinedTensorImpl>::reclaim(result_));
    auto beta_ = beta.toByte();
...
Tensor & CUDAByteType::th_addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta, Scalar alpha) const {
    const DeviceGuard device_guard(self);
    auto self_ = checked_tensor_unwrap(self,"self",1, false, Backend::CUDA, ScalarType::Byte);
    auto beta_ = beta.toByte();
    auto alpha_ = alpha.toByte();
