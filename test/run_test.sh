...
#distributed_set_up
#BACKEND=gloo WORLD_SIZE=3 INIT_METHOD='file://'$TEMP_DIR'/shared_init_file' $PYCMD ./test_distributed.py TestTCPOrGloo.test_all_gather
#distributed_tear_down

#MASTER_PORT = '29500'
#MASTER_ADDR = '127.0.0.1'
echo "Running distributed tests for the Gloo backend with tcp init_method"
#distributed_set_up
#BACKEND=gloo WORLD_SIZE=3 INIT_METHOD='tcp://127.0.0.1:29500' $PYCMD ./test_distributed.py TestTCPOrGloo.test_all_gather
#distributed_tear_down
