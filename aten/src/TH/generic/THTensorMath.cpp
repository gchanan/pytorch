...
{
  THTensor_(resizeNdLegacy)(r_, index->nDimension, index->size, NULL);
...
#define TENSOR_IMPLEMENT_LOGICAL(NAME,OP)				\
  ...
  {									\
    THByteTensor_resizeNdLegacy(r_, t->nDimension, t->size, NULL);		\
  ...
  {									\
    THTensor_(resizeNdLegacy)(r_, t->nDimension, t->size, NULL);		\
    TH_TENSOR_APPLY2(real, r_, real, t,					\
		     *r__data = (*t_data OP value) ? 1 : 0;); \
  }									\
  void THTensor_(NAME##Tensor)(THByteTensor *r_, THTensor *ta, THTensor *tb) \
  {									\
    THByteTensor_resizeNdLegacy(r_, ta->nDimension, ta->size, NULL);		\
  ...
  {									\
    THTensor_(resizeNdLegacy)(r_, ta->nDimension, ta->size, NULL);		\
