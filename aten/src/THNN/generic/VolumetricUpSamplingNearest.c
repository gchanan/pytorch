    ...
    int scale_factor)
{
  ...
  int inputDepth   = THTensor_(size)(input, input->new_dim()-3);
  int inputHeight  = THTensor_(size)(input, input->new_dim()-2);
  int inputWidth   = THTensor_(size)(input,  input->new_dim()-1);
  int outputDepth  = inputDepth * scale_factor;
  int outputHeight = inputHeight * scale_factor;
  int outputWidth  = inputWidth * scale_factor;
  ...
  int dW = scale_factor;
  int dH = scale_factor;
  int xDim = input->new_dim()-3;
  int yDim = input->new_dim()-2;
  int zDim = input->new_dim()-1;

  // dims
  int idim = input->new_dim();
    ...
    int scale_factor)
{
  ...
  int dH = scale_factor;
  int dT = scale_factor;
  int xDim = gradInput->new_dim()-3;
  int yDim = gradInput->new_dim()-2;
  int zDim = gradInput->new_dim()-1;

  // dims
  int idim = gradInput->new_dim();  // Guaranteed to be between 3 and 5
