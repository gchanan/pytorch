...
template<typename ScalarType, typename ScalarTypeOut, typename TensorType, typename TensorTypeOut, class Op>
void THC_logicalValue(THCState *state,
  ...
  if (!THC_pointwiseApply2<ScalarType, ScalarTypeOut>(state, self_, src, op)) {
