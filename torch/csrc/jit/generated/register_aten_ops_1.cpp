...
RegisterOperators reg({
  ...
  // Generated operators
  Operator(
      "aten::__and__(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("__and___out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::__and___out(
              result,
  ...
  Operator(
      "aten::__and__(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("__and___out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::__and___out(
  ...
  Operator(
      "aten::_abs(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_abs_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_abs_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_acos(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_acos");
      
          auto result_ = at::_acos(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      ...
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_addr_");
  ...
  Operator(
      "aten::_arange(Scalar end, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_arange_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_arange_out(
              result,
  ...
  Operator(
      "aten::_arange(Scalar start, Scalar end, Scalar step, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_arange_out");
  ...
  Operator(
      "aten::_asin(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_asin_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_asin_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_ceil(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_ceil");
      
          auto result_ = at::_ceil(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_copy_ignoring_overlaps_(Tensor(a!) self, Tensor src) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_copy_ignoring_overlaps_");
          auto self = (std::move(peek(stack, 0, 2))).toTensor();
          auto result_ = at::_copy_ignoring_overlaps_(
              self,
              (std::move(peek(stack, 1, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_cos(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cos_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_cos_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_erf(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_erf");
      
          auto result_ = at::_erf(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_erfc(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_erfc");
      
          auto result_ = at::_erfc(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_expm1(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_expm1");
      
          auto result_ = at::_expm1(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_fill_(Tensor(a!) self, Tensor value) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_fill_");
          auto self = (std::move(peek(stack, 0, 2))).toTensor();
          auto result_ = at::_fill_(
              self,
              (std::move(peek(stack, 1, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_fill_(Tensor(a!) self, Scalar value) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_fill_");
          auto self = (std::move(peek(stack, 0, 2))).toTensor();
          auto result_ = at::_fill_(
  ...
  Operator(
      "aten::_getri(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_getri");
      
          auto result_ = at::_getri(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_linspace(Scalar start, Scalar end, int steps, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_linspace_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_linspace_out(
              result,
              (std::move(peek(stack, 0, 4))).toScalar(),
              (std::move(peek(stack, 1, 4))).toScalar(),
  ...
  Operator(
      "aten::_log10(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_log10");
      
          auto result_ = at::_log10(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_log(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_log_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_log_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_mm(Tensor self, Tensor mat2) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::_mv(Tensor self, Tensor vec) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::_rsqrt(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_rsqrt");
      
          auto result_ = at::_rsqrt(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_sigmoid_forward(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sigmoid_forward_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_sigmoid_forward_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_sigmoid(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sigmoid_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_sigmoid_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_sinh(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sinh");
      
          auto result_ = at::_sinh(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_sqrt(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sqrt");
      
          auto result_ = at::_sqrt(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_tan(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_tan");
      
          auto result_ = at::_tan(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_tanh_forward(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_tanh_forward_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_tanh_forward_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_tanh(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_tanh_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_tanh_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = (self)._th_digamma_(
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = (self)._th_exponential_(
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto self = (std::move(peek(stack, 0, 3))).toTensor();
          auto result_ = (self)._th_masked_scatter_(
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toTensor()
          );
          drop(stack, 3);
  ...
  Operator(
      "aten::_th_ndimension(Tensor self) -> int",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_th_ndimension");
      
          auto result_ = ((std::move(peek(stack, 0, 1))).toTensor())._th_ndimension(
  ...
  Operator(
      "aten::_th_potrs(Tensor self, Tensor input2, bool upper=True, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_th_potrs_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_th_potrs_out(
              result,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toBool()
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto self = (std::move(peek(stack, 0, 2))).toTensor();
          auto result_ = (self)._th_remainder_(
              (std::move(peek(stack, 1, 2))).toTensor()
          );
          drop(stack, 2);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_th_storage_offset(Tensor self) -> int",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_th_storage_offset");
      
          auto result_ = ((std::move(peek(stack, 0, 1))).toTensor())._th_storage_offset(
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto self = (std::move(peek(stack, 0, 4))).toTensor();
          auto result_ = (self)._th_uniform_(
              (std::move(peek(stack, 1, 4))).toDouble(),
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = ((std::move(peek(stack, 0, 2))).toTensor())._th_view(
  ...
  Operator(
      "aten::_trunc(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_trunc_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_trunc_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::adaptive_avg_pool3d_forward(Tensor self, int[3] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("adaptive_avg_pool3d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::adaptive_avg_pool3d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
  ...
  Operator(
      "aten::adaptive_max_pool2d_forward(Tensor self, int[2] output_size) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("adaptive_max_pool2d_forward");
      
          auto result_ = at::adaptive_max_pool2d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::avg_pool2d_forward(Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, bool ceil_mode, bool count_include_pad, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("avg_pool2d_forward_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::avg_pool2d_forward_out(
              output,
  ...
  Operator(
      "aten::avg_pool3d_forward(Tensor self, int[3] kernel_size, int[3] stride, int[3] padding, bool ceil_mode, bool count_include_pad) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("avg_pool3d_forward");
      
          auto result_ = at::avg_pool3d_forward(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toIntList()->elements(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              (std::move(peek(stack, 3, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::elu_forward_(Tensor(a!) self, Scalar alpha, Scalar scale, Scalar input_scale) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("elu_forward_");
          auto self = (std::move(peek(stack, 0, 4))).toTensor();
          auto result_ = at::elu_forward_(
              self,
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toScalar(),
              (std::move(peek(stack, 3, 4))).toScalar()
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  ...
                  .layout((std::move(peek(stack, 3, 5))).to<at::Layout>())
                  .device((std::move(peek(stack, 4, 5))).to<at::Device>());
          auto result_ = torch::empty_strided(
  ...
  Operator(
      "aten::fractional_max_pool2d_forward(Tensor self, int[2] kernel_size, int[2] output_size, Tensor random_samples) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("fractional_max_pool2d_forward");
      
          auto result_ = at::fractional_max_pool2d_forward(
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toIntList()->elements(),
              (std::move(peek(stack, 2, 4))).toIntList()->elements(),
              (std::move(peek(stack, 3, 4))).toTensor()
  ...
  Operator(
      "aten::glu_forward(Tensor self, int dim) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("glu_forward");
      
          auto result_ = at::glu_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toInt()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  ...
                  .layout((std::move(peek(stack, 2, 4))).to<at::Layout>())
                  .device((std::move(peek(stack, 3, 4))).to<at::Device>());
          auto result_ = torch::hann_window(
  ...
  Operator(
      "aten::hardtanh_forward_(Tensor(a!) self, Scalar min_val, Scalar max_val) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("hardtanh_forward_");
          auto self = (std::move(peek(stack, 0, 3))).toTensor();
          auto result_ = at::hardtanh_forward_(
              self,
              (std::move(peek(stack, 1, 3))).toScalar(),
              (std::move(peek(stack, 2, 3))).toScalar()
          );
  ...
  Operator(
      "aten::leaky_relu_forward(Tensor self, Scalar negative_slope) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("leaky_relu_forward");
      
          auto result_ = at::leaky_relu_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toScalar()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::max_pool3d_with_indices_forward(Tensor self, int[3] kernel_size, int[3] stride, int[3] padding, int[3] dilation, bool ceil_mode) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("max_pool3d_with_indices_forward");
      
          auto result_ = at::max_pool3d_with_indices_forward(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toIntList()->elements(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              (std::move(peek(stack, 3, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::max_unpool2d_forward(Tensor self, Tensor indices, int[2] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("max_unpool2d_forward");
      
          auto result_ = at::max_unpool2d_forward(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::nll_loss2d(Tensor self, Tensor target, Tensor weight=None, int reduction=ElementwiseMean, int ignore_index=-100, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::nll_loss(Tensor self, Tensor target, Tensor weight=None, int reduction=ElementwiseMean, int ignore_index=-100, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::potrf(Tensor self, bool upper=True, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("potrf_out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::potrf_out(
              result,
              (std::move(peek(stack, 0, 3))).toTensor(),
  ...
  Operator(
      "aten::reflection_pad1d_forward(Tensor self, int[2] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("reflection_pad1d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::reflection_pad1d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::reflection_pad2d_forward(Tensor self, int[4] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("reflection_pad2d_forward");
      
          auto result_ = at::reflection_pad2d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::replication_pad1d_forward(Tensor self, int[2] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("replication_pad1d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::replication_pad1d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::replication_pad2d_forward(Tensor self, int[4] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("replication_pad2d_forward");
      
          auto result_ = at::replication_pad2d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::smooth_l1_loss_forward(Tensor self, Tensor target, int reduction) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("smooth_l1_loss_forward");
      
          auto result_ = at::smooth_l1_loss_forward(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toInt()
          );
  ...
  Operator(
      "aten::softshrink_forward(Tensor self, Scalar lambd) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("softshrink_forward");
      
          auto result_ = at::softshrink_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toScalar()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::th_addmm_(Tensor(a!) self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("th_addmm_");
          auto self = (std::move(peek(stack, 0, 5))).toTensor();
          auto result_ = at::th_addmm_(
              self,
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toTensor(),
              (std::move(peek(stack, 3, 5))).toScalar(),
  ...
  Operator(
      "aten::thnn_conv3d_backward(Tensor grad_output, Tensor self, Tensor weight, int[3] kernel_size, int[3] stride, int[3] padding, Tensor finput, Tensor fgrad_input, bool[3] output_mask=[True, True, True]) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::thnn_conv_dilated3d_backward(Tensor grad_output, Tensor self, Tensor weight, int[3] kernel_size, int[3] stride, int[3] padding, int[3] dilation, Tensor columns, Tensor ones, bool[3] output_mask=[True, True, True]) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::thnn_conv_transpose3d_backward(Tensor grad_output, Tensor self, Tensor weight, int[3] kernel_size, int[3] stride, int[3] padding, int[3] output_padding, int[3] dilation, Tensor finput, Tensor fgrad_input, bool[3] output_mask=[True, True, True]) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::threshold_backward(Tensor grad_output, Tensor self, Scalar threshold, Scalar value, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("threshold_backward_out");
          auto grad_input = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::threshold_backward_out(
              grad_input,
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toScalar(),
  ...
  Operator(
      "aten::threshold_forward(Tensor self, Scalar threshold, Scalar value) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("threshold_forward");
      
          auto result_ = at::threshold_forward(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toScalar(),
              (std::move(peek(stack, 2, 3))).toScalar()
          );
  ...
  Operator(
      "aten::upsample_bilinear2d_forward(Tensor self, int[2] output_size, bool align_corners) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_bilinear2d_forward");
      
          auto result_ = at::upsample_bilinear2d_forward(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements(),
              (std::move(peek(stack, 2, 3))).toBool()
          );
  ...
  Operator(
      "aten::upsample_linear1d_forward(Tensor self, int[1] output_size, bool align_corners) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_linear1d_forward");
      
          auto result_ = at::upsample_linear1d_forward(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements(),
              (std::move(peek(stack, 2, 3))).toBool()
          );
  ...
  Operator(
      "aten::upsample_nearest1d_forward(Tensor self, int[1] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_nearest1d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::upsample_nearest1d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::upsample_nearest2d_forward(Tensor self, int[2] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_nearest2d_forward");
      
          auto result_ = at::upsample_nearest2d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
