...
RegisterOperators reg({
  ...
  Operator(
      "aten::__or__(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("__or___out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::__or___out(
              result,
  ...
  Operator(
      "aten::__or__(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("__or___out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::__or___out(
  ...
  Operator(
      "aten::__xor__(Tensor self, Tensor other, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("__xor___out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::__xor___out(
              result,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor()
          );
  ...
  Operator(
      "aten::__xor__(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("__xor___out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::__xor___out(
  ...
  Operator(
      "aten::_abs(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_abs");
      
          auto result_ = at::_abs(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_addmv_(Tensor(a!) self, Tensor mat, Tensor vec, *, Scalar beta=1, Scalar alpha=1) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_addmv_");
          auto self = (std::move(peek(stack, 0, 5))).toTensor();
          auto result_ = at::_addmv_(
              self,
              (std::move(peek(stack, 1, 5))).toTensor(),
  ...
  Operator(
      ...
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_addr_out");
  ...
  Operator(
      "aten::_asin(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_asin");
      
          auto result_ = at::_asin(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_atan(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_atan_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_atan_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cat_out");
  ...
  Operator(
      "aten::_cos(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cos");
      
          auto result_ = at::_cos(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_cosh(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cosh_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_cosh_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cumprod_out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
  ...
  Operator(
      ...
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cumsum_out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
  ...
  Operator(
      "aten::_exp(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_exp_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_exp_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_floor(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_floor_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_floor_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_ger(Tensor self, Tensor vec2, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_ger_out");
          auto result = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_ger_out(
              result,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor()
          );
  ...
  Operator(
      "aten::_gesv_single(Tensor self, Tensor A) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_gesv_single");
      
          auto result_ = at::_gesv_single(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_indexCopy_(Tensor(a!) self, int dim, Tensor index, Tensor source) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_indexCopy_");
          auto self = (std::move(peek(stack, 0, 4))).toTensor();
          auto result_ = at::_indexCopy_(
              self,
  ...
  Operator(
      "aten::_log(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_log");
      
          auto result_ = at::_log(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_log1p(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_log1p_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_log1p_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_log2(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_log2_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_log2_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_logspace(Scalar start, Scalar end, int steps, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_logspace_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_logspace_out(
              result,
  ...
  Operator(
      "aten::_range(Scalar start, Scalar end, Scalar step, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_range_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_range_out(
              result,
              (std::move(peek(stack, 0, 4))).toScalar(),
              (std::move(peek(stack, 1, 4))).toScalar(),
  ...
  Operator(
      "aten::_round(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_round_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_round_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_sigmoid(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sigmoid");
      
          auto result_ = at::_sigmoid(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_sigmoid_backward(Tensor grad_output, Tensor output, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sigmoid_backward_out");
          auto grad_input = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_sigmoid_backward_out(
              grad_input,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor()
          );
  ...
  Operator(
      "aten::_sigmoid_forward(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sigmoid_forward");
      
          auto result_ = at::_sigmoid_forward(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_sin(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sin_out");
          auto result = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_sin_out(
              result,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = torch::_sparse_coo_tensor_unsafe(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              options
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = torch::_sparse_coo_tensor_with_dims_and_tensors(
              (std::move(peek(stack, 0, 8))).toInt(),
  ...
  Operator(
      "aten::_tanh(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_tanh");
      
          auto result_ = at::_tanh(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_tanh_backward(Tensor grad_output, Tensor output, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_tanh_backward_out");
          auto grad_input = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_tanh_backward_out(
              grad_input,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor()
          );
  ...
  Operator(
      "aten::_tanh_forward(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_tanh_forward");
      
          auto result_ = at::_tanh_forward(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto self = (std::move(peek(stack, 0, 4))).toTensor();
          auto result_ = (self)._th_addcdiv_(
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toTensor(),
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = (self)._th_geometric_(
              (std::move(peek(stack, 1, 3))).toDouble(),
              nullptr
          );
          drop(stack, 3);
  ...
  Operator(
      "aten::_th_potrf(Tensor self, bool upper=True, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_th_potrf_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_th_potrf_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
  ...
  Operator(
      "aten::_th_potrs(Tensor self, Tensor input2, bool upper=True) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_th_potrs");
      
          auto result_ = at::_th_potrs(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toBool()
          );
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto self = (std::move(peek(stack, 0, 4))).toTensor();
          auto result_ = (self)._th_scatter_(
              (std::move(peek(stack, 1, 4))).toInt(),
              (std::move(peek(stack, 2, 4))).toTensor(),
              (std::move(peek(stack, 3, 4))).toTensor()
          );
  ...
  Operator(
      "aten::_trunc(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_trunc");
      
          auto result_ = at::_trunc(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::adaptive_avg_pool2d_forward(Tensor self, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("adaptive_avg_pool2d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::adaptive_avg_pool2d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
  ...
  Operator(
      "aten::adaptive_avg_pool3d_forward(Tensor self, int[3] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("adaptive_avg_pool3d_forward");
      
          auto result_ = at::adaptive_avg_pool3d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::avg_pool2d_forward(Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, bool ceil_mode, bool count_include_pad) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("avg_pool2d_forward");
      
          auto result_ = at::avg_pool2d_forward(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toIntList()->elements(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              (std::move(peek(stack, 3, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::binary_cross_entropy_forward(Tensor self, Tensor target, Tensor weight, int reduction, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("binary_cross_entropy_forward_out");
          auto output = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::binary_cross_entropy_forward_out(
              output,
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toTensor(),
  ...
  Operator(
      "aten::binary_cross_entropy(Tensor self, Tensor target, Tensor weight=None, int reduction=ElementwiseMean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = torch::blackman_window(
  ...
  Operator(
      "aten::elu_forward(Tensor self, Scalar alpha, Scalar scale, Scalar input_scale, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("elu_forward_out");
          auto output = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::elu_forward_out(
              output,
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toScalar(),
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  ...
                  .layout((std::move(peek(stack, 3, 5))).to<at::Layout>())
                  .device((std::move(peek(stack, 4, 5))).to<at::Device>());
          auto result_ = torch::full(
              (std::move(peek(stack, 0, 5))).toIntList()->elements(),
              (std::move(peek(stack, 1, 5))).toScalar(),
              options
          );
          drop(stack, 5);
  ...
  Operator(
      "aten::hardtanh_forward(Tensor self, Scalar min_val, Scalar max_val, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("hardtanh_forward_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::hardtanh_forward_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toScalar()
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = ((std::move(peek(stack, 0, 1))).toTensor()).is_contiguous(
  ...
  Operator(
      "aten::l1_loss_forward(Tensor self, Tensor target, int reduction, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("l1_loss_forward_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::l1_loss_forward_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::l1_loss(Tensor self, Tensor target, int reduction=ElementwiseMean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::leaky_relu_forward_(Tensor(a!) self, Scalar negative_slope) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("leaky_relu_forward_");
          auto self = (std::move(peek(stack, 0, 2))).toTensor();
          auto result_ = at::leaky_relu_forward_(
              self,
              (std::move(peek(stack, 1, 2))).toScalar()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  ...
                  .device((std::move(peek(stack, 5, 6))).to<at::Device>());
          auto result_ = torch::logspace(
              (std::move(peek(stack, 0, 6))).toScalar(),
  ...
  Operator(
      "aten::max_pool2d_with_indices_forward(Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool ceil_mode) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("max_pool2d_with_indices_forward");
      
          auto result_ = at::max_pool2d_with_indices_forward(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toIntList()->elements(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              (std::move(peek(stack, 3, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::max_unpool3d_forward(Tensor self, Tensor indices, int[3] output_size, int[3] stride, int[3] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("max_unpool3d_forward_out");
          auto output = (std::move(peek(stack, 5, 6))).toTensor();
          auto result_ = at::max_unpool3d_forward_out(
              output,
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::mse_loss_forward(Tensor self, Tensor target, int reduction, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("mse_loss_forward_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::mse_loss_forward_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::mse_loss(Tensor self, Tensor target, int reduction=ElementwiseMean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::multi_margin_loss_forward(Tensor self, Tensor target, Scalar p, Scalar margin, Tensor weight, int reduction, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("multi_margin_loss_forward_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::multi_margin_loss_forward_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
  ...
  Operator(
      "aten::multi_margin_loss(Tensor self, Tensor target, Scalar p=1, Scalar margin=1, Tensor weight=None, int reduction=ElementwiseMean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  ...
                  .layout((std::move(peek(stack, 2, 4))).to<at::Layout>())
                  .device((std::move(peek(stack, 3, 4))).to<at::Device>());
          auto result_ = torch::randn(
              (std::move(peek(stack, 0, 4))).toIntList()->elements(),
              options
          );
          drop(stack, 4);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::reflection_pad1d_forward(Tensor self, int[2] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("reflection_pad1d_forward");
      
          auto result_ = at::reflection_pad1d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::replication_pad1d_forward(Tensor self, int[2] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("replication_pad1d_forward");
      
          auto result_ = at::replication_pad1d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::replication_pad3d_forward(Tensor self, int[6] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("replication_pad3d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::replication_pad3d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::soft_margin_loss_forward(Tensor self, Tensor target, int reduction, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("soft_margin_loss_forward_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::soft_margin_loss_forward_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::soft_margin_loss(Tensor self, Tensor target, int reduction=ElementwiseMean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::softplus_forward(Tensor self, Scalar beta, Scalar threshold, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("softplus_forward_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::softplus_forward_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toScalar()
  ...
  Operator(
      "aten::th_addmm(Tensor self, Tensor mat1, Tensor mat2, *, Scalar beta=1, Scalar alpha=1, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("th_addmm_out");
          auto result = (std::move(peek(stack, 5, 6))).toTensor();
          auto result_ = at::th_addmm_out(
              result,
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toTensor(),
  ...
  Operator(
      "aten::thnn_conv2d_backward(Tensor grad_output, Tensor self, Tensor weight, int[2] kernel_size, int[2] stride, int[2] padding, Tensor finput, Tensor fgrad_input, bool[3] output_mask=[True, True, True]) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::thnn_conv_depthwise2d_backward(Tensor grad_output, Tensor self, Tensor weight, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, bool[2] output_mask=[True, True]) -> (Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::thnn_conv_dilated2d_backward(Tensor grad_output, Tensor self, Tensor weight, int[2] kernel_size, int[2] stride, int[2] padding, int[2] dilation, Tensor columns, Tensor ones, bool[3] output_mask=[True, True, True]) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::thnn_conv_transpose2d_backward(Tensor grad_output, Tensor self, Tensor weight, int[2] kernel_size, int[2] stride, int[2] padding, int[2] output_padding, int[2] dilation, Tensor columns, Tensor ones, bool[3] output_mask=[True, True, True]) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::threshold_backward(Tensor grad_output, Tensor self, Scalar threshold, Scalar value) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::threshold_forward_(Tensor(a!) self, Scalar threshold, Scalar value) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("threshold_forward_");
          auto self = (std::move(peek(stack, 0, 3))).toTensor();
          auto result_ = at::threshold_forward_(
              self,
              (std::move(peek(stack, 1, 3))).toScalar(),
              (std::move(peek(stack, 2, 3))).toScalar()
          );
  ...
  Operator(
      "aten::upsample_nearest1d_forward(Tensor self, int[1] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_nearest1d_forward");
      
          auto result_ = at::upsample_nearest1d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::upsample_nearest3d_forward(Tensor self, int[3] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_nearest3d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::upsample_nearest3d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::upsample_trilinear3d_forward(Tensor self, int[3] output_size, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("upsample_trilinear3d_forward_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::upsample_trilinear3d_forward_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toIntList()->elements(),
              (std::move(peek(stack, 2, 4))).toBool()
